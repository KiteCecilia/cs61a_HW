...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    "*** YOUR CODE HERE ***"
    outcome = [dice() for i in range(num_rolls)]
    if 1 in outcome:
        return 1
    else:
        return sum(outcome)
...
def boar_brawl(player_score, opponent_score):
    ...
    score = 3 * abs(opponent_tens - player_ones)
    return max(score, 1)
    # END PROBLEM 2
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if score + boar_brawl(score, opponent_score) >= GOAL:
        return 0
    elif score + 1 >= GOAL or score + 2 >= GOAL:
        return 1
    elif boar_strategy(score, opponent_score) == 0 or sus_strategy(score, opponent_score) == 0:
        return 0
    else:
        return 6
    # END PROBLEM 12
